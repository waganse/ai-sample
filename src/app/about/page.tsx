  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              60歳からの新しい人生の章で、同世代の仲間との meaningful な関係を築く場所を提供すること。
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">お相手探し</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">安全なメッセージ</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">本人確認</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">イベント</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">簡単設定</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">安全への取り組み</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">本人確認の徹底</h3>
                  <p className="text-gray-600">身分証明書による厳格な本人確認を実施しています。</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">24時間監視体制</h3>
                  <p className="text-gray-600">専門スタッフによる24時間体制での監視とサポートを行っています。</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">個人情報の取り扱いには細心の注意を払い、厳重に管理しています。</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">通報・ブロック機能</h3>
                  <p className="text-gray-600">不適切な行為を見つけた場合、すぐに通報・ブロックできます。</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">専門サポート</h3>
                  <p className="text-gray-600">ご不明な点があれば、専門スタッフが丁寧にサポートいたします。</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">セキュアな通信</h3>
                  <p className="text-gray-600">すべての通信は暗号化され、安全に保護されています。</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-primary-200 mt-6">
            すでにアカウントをお持ちの方は{' '}
            <Link href="/auth/login" className="text-white hover:text-primary-100 font-medium underline">
              こちらからログイン
            </Link>
          </p>
        </div>
