  ...
  const supportFeatures = [
    {
      icon: '📧',
      title: 'メールサポート',
      description: '操作方法がわからない時、困った時はメールでサポートします。お問い合わせフォームからいつでもご相談いただけます。',
      details: ['24時間受付', '営業日内に返信', 'サポートフォーム完備'],
    },
    {
      icon: '🛡️',
      title: '安全パトロール',
      description: '不適切な利用者の監視・排除を徹底しています。身分証明書による本人確認も行っています。',
      details: ['24時間365日監視体制', '身分証明書確認', '通報システム'],
    },
    {
      icon: '📚',
      title: '使い方ガイド',
      description: '図解入りのガイドブックを無料でお送りします。スマートフォンが苦手な方でも安心です。',
