  ...
  const preparationSteps = [
    {
      ...
      title: '無料会員登録',
      description:
        'メールアドレスと基本情報だけで簡単登録。7日間は完全無料でお試しいただけます。',
      icon: '📝',
      time: '約3分',
      details: [
        'メールアドレス登録',
  ...
  const personalSteps = [
    {
      ...
      title: '相手を探す',
      description:
        '条件検索やおすすめ機能で気になる方を見つけましょう。焦らずゆっくりと。',
      icon: '🔍',
      time: '自由に',
    ...
    },
    {
      ...
      title: '実際にお会いする',
      description:
        'メッセージで親しくなったら、安全な場所でのお食事やお茶から始めましょう。',
      icon: '☕',
      time: 'お互いのペース',
  ...
  const communitySteps = [
    {
      ...
      title: 'コミュニティを探す',
      description:
        '趣味や興味が合う仲間が集まるコミュニティに参加。同じ価値観の方々と出会えます。',
      icon: '👥',
      time: '自由に',
      details: [
        '趣味コミュニティ参加',
    ...
    },
    {
      ...
      title: 'コミュニティイベントに参加',
      description:
        'オフラインイベントや趣味活動に参加して、実際に顔を合わせて交流を深めましょう。',
      icon: '🎪',
      time: '月1-2回程度',
    ...
    },
    {
      ...
      title: '個人的な関係を深める',
      description:
        'コミュニティで親しくなった方と、個人的にもお付き合いを始めてみましょう。',
      icon: '💕',
      time: '自然な流れで',
