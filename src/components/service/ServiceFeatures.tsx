  ...
  const features = [
    {
      ...
      title: '年齢層に特化',
      description:
        '60歳以上の方々のためのコミュニティ。同世代だからこそ分かり合える関係を。',
    ...
    },
    {
      ...
      title: '安心・安全',
      description:
        '身元確認と24時間監視システムで、安心してご利用いただけます。',
    ...
    },
    {
      ...
      title: 'リーズナブル',
      description:
        '月額980円から。他社の半額以下で、質の高いサービスをご提供。',
    ...
    },
    {
      ...
      title: '多様な出会い',
      description:
        'パートナー探しから友人作りまで、あなたの目的に合った出会いを。',
    ...
    },
    {
      ...
      title: '丁寧なサポート',
      description:
        '専門スタッフによるメールサポート。使い方から出会いまで親身にサポート。',
