  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden">
      ...
      <Suspense fallback={null}>
        <HeroWebGL />
        <WebGLBackground theme="primary" intensity="high" />
      </Suspense>

      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary-50/80 via-transparent to-purple-50/80" />
      ...
      >
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-pink-300 to-purple-400 rounded-full opacity-30 animate-pulse blur-sm" />
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-yellow-300 to-orange-400 rounded-full opacity-40 animate-bounce blur-sm" />
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-gradient-to-br from-blue-300 to-cyan-400 rounded-full opacity-35 animate-pulse delay-1000 blur-sm" />
      </div>
      ...
      <div className="container-max relative z-20 min-h-[90vh] flex items-center">
        ...
        <div className="lg:hidden text-center space-y-6 mb-8 w-full">
          <div
            className={`inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-100 to-pink-100 rounded-full text-primary-800 font-medium text-sm backdrop-blur-sm border border-primary-200/50 ${
          ...
          >
            <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-4 shadow-xl border border-primary-100 hover:scale-105 transition-all duration-300 hover:shadow-2xl">
          ...
          >
            <button className="group relative overflow-hidden btn-primary text-lg px-8 py-4 w-full hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <span className="relative z-10">無料で始める（7日間無料）</span>
              <div className="absolute inset-0 bg-gradient-to-r from-primary-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </button>
          ...
          <div className="w-full max-w-7xl mx-auto relative grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
              <div className="space-y-6">
                <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-100 to-pink-100 rounded-full text-primary-800 font-medium text-sm backdrop-blur-sm border border-primary-200/50 animate-bounce-gentle">
                  🌸 60歳からの新しいスタート
                </div>
              ...
              <div className="flex flex-row gap-6">
                <button className="group relative overflow-hidden btn-primary text-xl px-12 py-5 hover:scale-105 transition-all duration-300 hover:shadow-2xl z-40">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-500 via-pink-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                </button>

                <Link href="/service">
                  <button className="group btn-secondary text-xl px-12 py-5 transition-all duration-300 hover:scale-105 hover:shadow-lg z-40 backdrop-blur-sm">
                    サービス詳細を見る
                    <svg
              ...
              <div className="grid grid-cols-3 gap-4 pt-8 max-w-2xl">
                <div className="text-center group hover:scale-105 transition-transform bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-primary-100 z-40">
            ...
            {/* Right Image Section with Enhanced 3D Effects */}
            <div className={`relative ${isVisible ? 'animate-fade-in-right' : 'opacity-0'}`}>
              <div
                className="relative bg-gradient-to-br from-white/90 to-gray-50/90 rounded-3xl p-6 shadow-2xl backdrop-blur-lg border border-white/50 hover:shadow-3xl transition-all duration-500"
                style={{
                ...
                <div className="bg-gradient-to-br from-primary-100/80 to-gray-100/80 rounded-2xl p-4 shadow-inner backdrop-blur-sm">
                  <div className="aspect-[4/5] rounded-xl relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/95 backdrop-blur-lg rounded-xl p-4 shadow-xl border border-white/50 transition-all duration-500 hover:bg-white">
