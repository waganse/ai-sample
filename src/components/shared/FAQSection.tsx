      ...
      questions: [
        {
          ...
          answer:
            'はい、縁日和は60歳以上の方々に特化したサービスです。同世代の方々との出会いを大切にしているため、年齢制限を設けさせていただいております。',
        },
        {
          question: 'スマートフォンが苦手でも使えますか？',
          answer:
            'もちろんです。縁日和は「シンプルで分かりやすい」をモットーに設計されています。大きな文字、分かりやすいボタン配置で、スマートフォンが苦手な方でも安心してご利用いただけます。',
        },
        {
  ...
  const compactFaqs: FAQItem[] = [
    {
      ...
      answer:
        'はい、大丈夫です。縁日和は60歳以上の方を対象に、特にシンプルで使いやすい設計にしています。大きな文字と直感的なボタン操作で、スマートフォンが苦手な方でも安心してお使いいただけます。また、メールサポートもございますので、困った時はいつでもお気軽にご連絡ください。',
    },
    {
    ...
    },
    {
      ...
      answer:
        'もちろんです。むしろ縁日和では「まずはお茶飲み友達から」という文化を大切にしています。趣味のサークル機能や日記機能を通じて、気軽な友人関係から始められる温かいコミュニティを目指しています。',
    },
    {
      ...
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            縁日和に関するご不明点にお答えします。こちらにない質問がございましたら、お気軽にお問い合わせください
          </p>
        </div>
