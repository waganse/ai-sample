...
// Dynamic import for WebGL components to avoid SSR issues
const SimpleWebGLBackground = dynamic(
  () => import('@/components/shared/WebGL/SimpleWebGLBackground'),
...
export default function WebGLHero() {
  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden">
      {/* WebGL Background - Only render on client */}
      {isClient && (
