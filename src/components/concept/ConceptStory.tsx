  ...
  const stories = [
    {
      ...
      content:
        '私たちは、皆様の安全と安心を何よりも大切にします。24時間365日、専門のスタッフがアプリ内を見守り、不適切な言動や不審な勧誘がないか、常に目を光らせています。まるで、馴染みの店の店主が「いらっしゃい！」と笑顔で迎えてくれるような、温かく、そして絶対に安全な場所。それが私たちの誇りです。',
      icon: '🏠',
    },
    {
      ...
      content:
        '「Tomorie」には、あなたと同じ時代を生きてきた、話の合う仲間がたくさんいます。ご近所の公園まで、一緒に散歩してくれる友達。思い出の歌謡曲で、一緒に盛り上がれるカラオケ仲間。丹精込めて育てたお庭の花を、褒め合える趣味友達。恋愛に限定しない、心温まる出会いがここにはあります。もちろん、人生のパートナーとして、もう一度ときめきを感じられる素敵な出会いが待っているかもしれません。',
      icon: '🤝',
    },
    {
      ...
      content:
        '「昔、編み物が好きだったな」「若い頃、よく写真を撮りに行ったっけ」そんな、心の奥にしまっていた「好き」を、もう一度取り出してみませんか？「手芸サークル」や「写真クラブ」など、様々な趣味の部屋（コミュニティ）をご用意しています。新しい趣味を始めるのも、昔取った杵柄を誰かに教えてあげるのも、ここでは自由です。あなたの人生経験が、誰かの新しい楽しみのきっかけになるのです。',
      icon: '✨',
    },
  ];
